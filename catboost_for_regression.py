# The example below first evaluates a CatBoostRegressor on the test problem using
# repeated k-fold cross-validation and reports the mean absolute error. Then a single
