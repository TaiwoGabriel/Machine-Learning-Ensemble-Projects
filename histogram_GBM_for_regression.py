# The example below first evaluates a HistGradientBoostingRegressor on the test
# problem using repeated k-fold cross-validation and reports the mean absolute error.
# Then a single model is fit on all available data and a single prediction is made
